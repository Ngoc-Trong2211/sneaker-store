    ...
    public SecurityFilterChain securityFilterChain(
        ...
        http
                ...
                .authorizeHttpRequests(request -> request
                        ...
                        .requestMatchers(HttpMethod.GET, "/dashboard/v1/top-pick").permitAll()
                        .requestMatchers(HttpMethod.GET, "/review/v1/reviews/check-eligibility").permitAll()
                        .requestMatchers(HttpMethod.GET, "/coupon/v1/coupons/validate").permitAll()
                        .requestMatchers(HttpMethod.GET, "/order/v1/orders/payment-status").permitAll()
                        .requestMatchers(HttpMethod.GET, "/payment/v1/sepay/sessions/**").permitAll()
                        .requestMatchers(HttpMethod.POST, "/order/v1/orders").permitAll()
                        .requestMatchers(HttpMethod.POST, "/payment/v1/sepay/sessions").permitAll()
                        .requestMatchers(HttpMethod.POST, "/payment/v1/sepay/webhook").permitAll()
